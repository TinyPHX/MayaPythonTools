...
def softIK_proc():
	...
	global ctrlName
	ctrlName = cmds.textField( "ctrlName", q = True, tx = True )
	global ikhName
	ikhName = cmds.textField( "ikhName", q = True, tx = True )
		
	global stretch
	stretch = cmds.checkBox( "stretch", q = True, v = True )
	global upAxis
	upAxis = cmds.radioButtonGrp( "upAxis", q = True, sl = True )
	global primaryAxis
	primaryAxis = cmds.radioButtonGrp( "primaryAxis", q = True, sl = True )
