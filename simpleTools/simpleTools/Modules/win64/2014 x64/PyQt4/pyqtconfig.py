...
_pkg_config = {
    'pyqt_bin_dir':      'C:\\Maya2014x64\\python\\Python',
    'pyqt_config_args':  '-w',
    'pyqt_mod_dir':      'C:\\Maya2014x64\\python\\Python\\Lib\\site-packages\\PyQt4',
    ...
    'pyqt_sip_dir':      'C:\\Maya2014x64\\python\\Python\\sip\\PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_NoPrintRangeBug -t Qt_4_8_0 -x Py_v3 -g',
    'pyqt_version':      0x040a00,
    'pyqt_version_str':  '4.10',
    'qt_data_dir':       'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2',
    'qt_dir':            'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2\\include',
    'qt_lib_dir':        'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040802,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2\\include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2\\lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'C:\\Maya2014x64\\qt-everywhere-opensource-src-4.8.2\\bin\\\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
