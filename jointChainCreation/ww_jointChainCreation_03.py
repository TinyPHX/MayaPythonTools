...
def createJnt_cmd(*args):
    ...
    if parentCheck==True:
        if mirrorCheck==True:
            stdout.write("Joint chain created and mirrored with %i joints and parented under %s."%(updatedInptVal,parentObject))
        else:
            stdout.write("Joint chain created with %i joints and parented under %s."%(updatedInptVal,parentObject))
